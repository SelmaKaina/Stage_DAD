...
def get_archiveunit_id():
    ...
    archival_agency_archive_unit_identifier = str(num_entree) + "_" + str(num_paquet) + "_"
        ...
        for rp in liste_rp:  # Parcours de chaque numéro de reportage dans la liste
            ...
            for item in os.listdir(dir_path):  # Parcours de chaque élément dans le répertoire racine
                ...
                if (
                    ...
                    print("Extraction Exiftool du dossier " + item_path)
    ...
    for rp in liste_rp:
        ...
        for item in os.listdir(dir_path):
            if (
                ...
                item_path = os.path.join(dir_path, item)  # Chemin complet vers le dossier ou fichier
                print("Exécution de Siegfried sur le dossier " + item_path)
...
def create_dataobjectgroup(arbre, directory, liste_rp):
    """
        ...
        :param xml.etree.ElementTree.Element arbre: L'élément racine de l'arbre XML.
        ...
        for i in filenames:
            ...
            for num in liste_rp:
                ...
                if (
                    ...
                    if (
                            "DS_Store" not in item and "Thumbs" not in item and
                            "BridgeSort" not in item and "PM_lock" not in item and "desktop.ini" not in item and
                            "._" not in item and "/." not in item
                    ):
                        # Création de l'élément DataObjectGroup sous DataObjectPackage et de ses descendants
                        print("Création de l'élément BinaryDataObject du fichier " + item)
...
def package_metadata(arbre, data):
    ...
    for obj in binary_data_object:
        ...
        print("Inscription des métadonnées de l'élément BinaryDataObject du fichier "+item)
...
def ua_rp(directory, data_ir, arbre_rp, data, liste_rp, rattachement):
    ...
    if rattachement is not None:
        ...
        update_operation = ET.SubElement(management, "UpdateOperation")  # Sous-élément UpdateOperation
                ...
                for RP in data_ir:
                    if num == RP[0]:
                        if (
                            ...
                            print("Création de l'élément ArchiveUnit du dossier "+item)
    ...
    for item in os.listdir(directory):
        ...
        if os.path.isdir(item_path):
            ...
            if item.startswith('.'):
                ...
                print("Création de l'élément ArchiveUnit du fichier " + item)
...
def delete_duplicate_dog(arbre):
    ...
    for element, parent in objects_a_supprimer:
        print("Suppression du doublon : "+element.text)
...
def id_attrib(arbre, archive_unit_id):
    ...
    for au in aus:
        ...
        print("Attribution de l'identifiants de l'UA : "+au.find(".//Title").text)
        ...
        if au.find(".//DescriptionLevel").text == "Item":
            ...
            for obj in data_object_group:
                print("Attribution des identifiants du DataObjectGroup : "+obj.find(".//Filename").text)
                got = got + 1
                ...
                if temp_hash == message_digest:
                    print("Mise à jour du DataObjectGroupReferenceId de l'UA : " + au.find(".//Title").text)
